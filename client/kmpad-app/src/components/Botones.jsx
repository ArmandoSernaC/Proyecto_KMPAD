...
class Botones extends Component {
    ...
    rellenarForm=()=>{
        if(this.props.type == "Ventas"){ 
             ...
             document.getElementById(`namefrutaEdit${this.props.type}`).value =    this.props.info.namefruit ;
            ...
            document.getElementById(`frutEdit${this.props.type}`).value =    this.props.info.id ;
            document.getElementById(`namefrutaEdit${this.props.type}`).value =   this.props.info.namefruit ;
            document.getElementById(`precioEdit${this.props.type}`).value =    this.props.info.Unitcost ; 
            document.getElementById(`cantidadEdit${this.props.type}`).value =     this.props.info.amount ;
                    
            if(this.props.info.Disponibility_update==true){
                document.getElementById(`inlineRadio1Edit${this.props.type}`).checked=true
            }
            else {
                document.getElementById(`inlineRadio2Edit${this.props.type}`).checked=true
            }
            ...
            document.getElementById(`namepersonaEdit${this.props.type}`).value =    this.props.info.nameperson ;
            document.getElementById(`idpersonaEdit${this.props.type}`).value =     this.props.info.idperson ;
            document.getElementById(`correopersonaEdit${this.props.type}`).value =    this.props.info.emailperson ;
            document.getElementById(`rolEdit${this.props.type}`).value =   this.props.info.roleuser ;
    ...
    delete = () =>{
        if(this.props.type == "Ventas"){
            ...
            Axios.delete( `http://localhost:3001/api/users/delete/${this.props.id}`)
        }else if (this.props.type == "Productos"){
            Axios.delete( `http://localhost:3001/api/products/delete/${this.props.id}`)
        }
    }
    showForm = () => {
