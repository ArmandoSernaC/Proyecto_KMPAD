                    ...
                    <div style={getStyleObjectFromString("display: flex; align-items: center; justify-content: space-around; color: #284b63;")}>
                        <div class="px-2 " style={getStyleObjectFromString("position:relative; text-align: center; justify-content: center;")}> 
                            ...
                            <form class="row g-3" id={"FormEdit"+ this.props.type}>                    
                                <div class="col-12 form-floating">
                                <input type="text" class="form-control" id={"frutEdit"+this.props.type} name={"frutEdit"+this.props.type} placeholder="Identificación" readonly="true"/>
                                        ...
                                        <div>
                                            <form class="row g-3" id={"FormEdit"+ this.props.type}>
                                                ...
                                                <div class="col-12 form-floating">
                                                    ...
                                                    <input type="number" class="form-control" id={"idpersonaEdit" + this.props.type} name={"idpersonaEdit" + this.props.type }placeholder="Identificación"/>
                                                    <label for="idpersonaEdit">Identificación</label>
                                                </div>

                                                <div class=" form-floating">
                                                    <input type="mail" class="form-control" id={"correopersonaEdit" + this.props.type} name={"correopersonaEdit"+ this.props.type} placeholder="Correo electrónico"/>
                                                    <label for="correopersonaEdit">Correo electrónico</label>
                                                </div>
                                                <div class="col-md-12 form-floating">
