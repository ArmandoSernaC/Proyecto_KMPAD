  ...
  render(){     
        return (               
            ...
            <div class="Panel-Busqueda  justify-content-lg-end ">  
                ...
                <input id = {"barrabusqueda"+ this.props.subtitle}class="form-control p-2 rounded-pill icon-placerholder buscador " type="search" placeholder=" Search" aria-label="Search" />
                </div>
                <div  class="p-2" >        
                <button type="button"  style={getStyleObjectFromString("display: flex; flex-direction: row;")} class="btn-primary rounded-pill" id={"btnbuscar"+ this.props.subtitle}> 
                    <div class="px-2">
