...
class ventas extends React.Component{
    render(){
        return(
            ...
            cons {Tregistro} = document.getElementById('TablaRegistro'),

            // Paneles de formularios (registrar y editar)
            cons  Pregistro = document.getElementById("reg-form"),
            cons  Peditar = document.getElementById("edit-form"),

            // Panel de info - no data
            cons  infodata = document.getElementById("Info-nodata"),


            // Formularios  registro
            cons  formFrutareg = document.getElementById("infofrutaFormReg"),
            cons  formClientereg = document.getElementById("infoClientFormReg"),

            // Formularios  editar
            cons  formFrutaedit = document.getElementById("infofrutaFormEdit"),
            cons  formClientedit = document.getElementById("infoClientFormEdit"),
            ...
            function crearFruta(form1,form2 ,type){
                ...
                if(type === 1){
                    ...
                    fruta = {
                        ...
                        Gramocost:form1.get("gramoreg"),
                        amount: form1.get("precioreg"),
                        totalCost:form1.get("totalCostreg"),
                        nameClient: form2.get("nameclientreg"),
                        idClient:form2.get("idclientreg"),
                        correoClient:form2.get("correoreg"),
                        dirClient:form2.get("dirreg"),
                    ...
                    fruta = {
                        ...
                        Gramocost:form1.get("gramoEdit"),
                        amount: form1.get("precioEdit"),
                        totalCost:form1.get("totalCostEdit"),
                        nameClient: form2.get("nameclientEdit"),
                        idClient:form2.get("idclientEdit"),
                        correoClient:form2.get("correoEdit"),
                        dirClient:form2.get("dirEdit"),
            ...
            function insertarFruta(fruta){
                ...
                formFrutareg.reset();   
                    ...
                    newlistaCell.textContent = fruta.idClient   
            ...
            let autocompletarForm = (id)=>{
                ...
                document.getElementById("correoEdit").value = infofruta.correoClient;
                document.getElementById("dirEdit").value = infofruta.dirClient;
            ...
            function rellenarinfo(fruta){
                let panelinfo = document.getElementById("panel-info").style.display="flex"
